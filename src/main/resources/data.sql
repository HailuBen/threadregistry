...
-- Heritage Sneakers
('Air Jordan 4 Retro', 'Sneakers', 'Men', 'New', 210.00, 'Classic Jordan 4 in Cement Grey', 1, '/images/jordan-4.jpg', CURRENT_TIMESTAMP),
('Ultraboost 22', 'Sneakers', 'Unisex', 'New', 190.00, 'High-performance running technology', 2, '/images/ultraboost.jpg', CURRENT_TIMESTAMP),
('Nike Air Force 1', 'Sneakers', 'Unisex', 'New', 110.00, 'The quintessential white-on-white sneaker', 1, '/images/af1.jpg', CURRENT_TIMESTAMP),
('Adidas Gazelle', 'Sneakers', 'Unisex', 'New', 100.00, 'Vintage suede indoor soccer silhouette', 2, '/images/gazelle.jpg', CURRENT_TIMESTAMP),
('Balenciaga Speed Trainer', 'Sneakers', 'Unisex', 'Pre-owned', 550.00, 'Iconic sock-style luxury runner', 8, '/images/balenciaga-speed.jpg', CURRENT_TIMESTAMP),

-- Premium Outerwear
('Moncler Maya Jacket', 'Outerwear', 'Men', 'New', 1250.00, 'Signature glossy down puffer jacket', 6, '/images/moncler-maya.jpg', CURRENT_TIMESTAMP),
('Stone Island Crinkle Reps', 'Outerwear', 'Men', 'New', 840.00, 'Hooded jacket with compass patch', 9, '/images/stone-island-jacket.jpg', CURRENT_TIMESTAMP),
('Levi''s Trucker Jacket', 'Outerwear', 'Unisex', 'New', 98.00, 'Original denim jacket since 1967', 3, '/images/levi-trucker.jpg', CURRENT_TIMESTAMP),
('Saint Laurent Teddy Jacket', 'Outerwear', 'Men', 'Authenticated', 2100.00, 'Classic wool varsity jacket with leather trim', 10, '/images/ysl-teddy.jpg', CURRENT_TIMESTAMP),
